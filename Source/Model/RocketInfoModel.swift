...
// MARK: - RocketInfoModel
struct RocketInfoModel: Codable {
    let height: Height?
    let diameter: HeightClass?
    let mass: Mass?
    ...
    let rocketInfoModelDescription, id: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case rocketInfoModelDescription = "description"
        case id
    }
}

// MARK: - HeightClass
struct HeightClass: Codable {
    let meters: Double?
    let feet: Int?
}
...
struct CompositeFairing: Codable {
    ...
    let diameter: PurpleDiameter?
}

// MARK: - PurpleDiameter
struct PurpleDiameter: Codable {
